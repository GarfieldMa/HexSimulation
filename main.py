...
if __name__ == '__main__':
    ...
    result = solves(hexagon_mf_operators=terms['hexagon_mf_operators'], t_a=terms['t_a'], t_b=terms['t_b'],
                    ...
                    Psi_s=terms['Psi_s'], Ns=terms['Ns'],Nsquare_s=terms['Nsquare_s'], EVals=terms['EVals'], err=params['err'], wall_time=params['wall_time'])
    dump_result(Psi_s=result['Psi_s'], Ns=result['Ns'], Nsquare_s=result['Nsquare_s'], EVals=result['EVals'], tA=terms['tA'], Ma=terms['Ma'], params=params)