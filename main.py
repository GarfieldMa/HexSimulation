...
if __name__ == '__main__':
    ...
    result = solves(hexagon_mf_operators=terms['hexagon_mf_operators'], g_a=terms['g_a'], g_b=terms['g_b'],
                    ...
                    Psi_s=terms['Psi_s'], Ns=terms['Ns'],Nsquare_s=terms['Nsquare_s'], NaN=terms['NaN'], EVals=terms['EVals'], EVecs=terms['EVecs'], err=params['err'], wall_time=params['wall_time'])
    dump_result(Psi_s=result['Psi_s'], Ns=result['Ns'], Nsquare_s=result['Nsquare_s'], NaN=result['NaN'], EVals=result['EVals'], EVecs=result['EVecs'], gA=terms['gA'], Ma=terms['Ma'], params=params)