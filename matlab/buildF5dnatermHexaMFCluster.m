function F5dnaterm=buildF5dnatermHexaMFCluster(K1up,K1dn,K2up,K2dn,K3up,K3dn,K4up,K4dn,K5up,K5dn,K6up,K6dn,t3dn)
BaseL=length(K1up);
F5dnaterm=zeros(BaseL,BaseL);
...
for K=1:BaseL
  ...
  %====================spin-dn meanfield terms with a=============================      
        if k1up==l1up && k1dn==l1dn && k2up==l2up && k2dn==l2dn && k3up==l3up && k3dn==l3dn && k4up==l4up && k4dn==l4dn && k5up==l5up && k5dn==l5dn-1 && k6up==l6up && k6dn==l6dn
			F5dnaterm(K,L)=F5dnaterm(K,L)-t3dn*sqrt(l5dn);
        end
    end
end
