function F5upaterm=buildF5upatermHexaMFCluster(K1up,K1dn,K2up,K2dn,K3up,K3dn,K4up,K4dn,K5up,K5dn,K6up,K6dn,t3up)
BaseL=length(K1up);
F5upaterm=zeros(BaseL,BaseL);
...
for K=1:BaseL
  ...
  %====================spin-up meanfield terms with a=============================      
        ...
        if k1up==l1up && k1dn==l1dn && k2up==l2up && k2dn==l2dn && k3up==l3up && k3dn==l3dn && k4up==l4up && k4dn==l4dn && k5up==l5up-1 && k5dn==l5dn && k6up==l6up && k6dn==l6dn
			F5upaterm(K,L)=F5upaterm(K,L)-t3up*sqrt(l5up);
        end
    end
end
